...
public class Main {
    public static void main(String[] args) {
        ...
        Proveedor proveedor = new Proveedor("Proveedor 1", "Calle 1, No. 1, Piso 1, Puerta 1, Ciudad 1, 11111, Pais 1", 
                                            "123456789", "987654321", "NIF123456789");
        Gafa gafa = new Gafa("Marca 1", 1.00, "Tipo Montura 1", "Color Montura 1", "Color Cristal 1", 100.0);
        Cliente cliente = new Cliente("Cliente 1", "Direccion 1", "123456789", "cliente1@email.com", new Date(), null);
